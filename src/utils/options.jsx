...
const propsalStatusOptions = [
    ...
    { value: 'open', label: 'Open', color: "#008ce4" },
...
const customerListTagsOptions = [
    ...
    { value: 'team', label: 'Team', color: '#008ce4' },
    ...
    { value: 'wholesale', label: 'Wholesale', color: '#008ce4' },
...
const leadsGroupsOptions = [
    ...
    { value: "group-c", label: "Group-C", color: "#008ce4" },
    ...
    { value: "group-i", label: "Group-I", color: "#008ce4" },
    { value: "group-j", label: "Group-J", color: "#ea4d4d" },
    { value: "group-k", label: "Group-K", color: "#41b2c4" },
]

const taskStatusOptions = [
    { value: 'inprogress', label: 'Inprogress', color: '#008ce4' },
...
const taskPriorityOptions = [
    { value: 'low', label: 'Low', color: '#008ce4' },
...
const taskTypeOptions = [
    { value: 'new', label: 'New', color: '#008ce4' },
...
const leadsSourceOptions = [
    { value: "manual", label: "Manual", icon: "feather-user" },
...
const projectStatusOptions = [
    { value: "in-projress", label: "In Projress", color: "#008ce4" },
...
const projectBillingOptions = [
    { value: "fixed-rate", label: "Fixed Rate", color: "#008ce4" },
...
const projectRoalOptions = [
    { value: "admin", label: "Admin", color: "#008ce4" },
