...
const statusOptions = [
    ...
    { value: 'inprogress', label: 'In Progress', color: '#008ce4' },
...
const orderOptions = [
    { value: 'ascending', label: 'Ascending', color: '#008ce4' },
